...
\title[GameBlade] % (optional, use only with long paper titles)
{GameBlade platform}

\subtitle
{A look at DIY gaming} % (optional)

\author[Xander Bos, Imara van Dinten] % (optional, use only with lots of authors)
{X.~Bos\and I.~van Dinten}
% - Use the \inst{?} command only if the authors have different
%   affiliation.

\institute[TI Hogeschool van Amsterdam] % (optional, but mostly needed)
{
  Technical Computing\\
